...
try:
    ...
    class GrootConfig:  # type: ignore[no-redef]
        """Sentinel — Groot not installed, isinstance checks will always be False."""
        pass
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    if pretrained_path:
        ...
        # if _GROOT_AVAILABLE and isinstance(policy_cfg, GrootConfig):
    ...
    # elif _GROOT_AVAILABLE and isinstance(policy_cfg, GrootConfig):
